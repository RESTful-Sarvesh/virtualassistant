app.service('chatService', function(){
       ...
       return{
            ...
            getHtmlForMap:function(attachment){
                window.alert("Hey I am inside gethtml for map")
                return;
            },
            ...
            getHtmlForLeaveForm:function(attachment){
              control =  '<div class="direct-chat-msg" style="margin-left:50px; margin-bottom:2px !important;">';
              control = control + '<div>';
              control = control + '<div class="direct-chat-text-no-arrow">';
            ...
            getHtmlForButtons5:function(data){
                ...
                if(data.type == "buttons"){
                    if(data.data.length == 2 && (data.title == '' && data.text == '')){
                        ...
                        for(var i = 0; i<data.data.length ;i++ ){
                            if(i==0){
                                control = control +'<div class="col-xs-6 col-sm-6 padding-right-1">';
                            ...
                            if(i==1){
                              control = control +'<div class="col-xs-6 col-sm-6 padding-left-1">';
                    ...
                    if(data.data.length == 3 && (data.title == '' && data.text == '')){
                        control = '<div class="row" style="margin-left:35px">';

                        for(var i = 0; i<data.data.length ;i++ ){
                            if(i==0){
                                control = control +'<div class="col-xs-4 col-sm-4 padding-right-0">';
                                control = control + '<div class="btn btn-chat border-btn-left-5" ng-click="vm.callIntent(\'' + data.data[i].callBackFn + '\')">';
                                control = control + data.data[i].text;
                                control = control + '</div>';
                                control = control + '</div>';
                            ...
                            if(i==1){
                              control = control +'<div class="col-xs-4 col-sm-4 padding-left-1 padding-right-1">';
                              control = control + '<div class="btn btn-chat" ng-click="vm.callIntent(\'' + data.data[i].callBackFn + '\')">';
                              control = control + data.data[i].text;
                              control = control + '</div>';
                              control = control + '</div>';
                            }
                            if(i==2){
                              control = control +'<div class="col-xs-4 col-sm-4 padding-left-0">';
                              control = control + '<div class="btn btn-chat border-btn-right-5" ng-click="vm.callIntent(\'' + data.data[i].callBackFn + '\')">';
                              control = control + data.data[i].text;
                              control = control + '</div>';
                              control = control + '</div>';
